...
public class ClimberNew extends SubsystemBase {
  ...
  private final TalonFX m_talonLeft = new TalonFX(kClimberRightPort, "rio");
   private final TalonFX m_talonRight = new TalonFX(kClimberLeftPort, "rio");
 ...
 // private double desiredPosition = 0;
  ...
  public ClimberNew() {
      ...
      m_ClimberCurrentState = ClimberStates.StateStopped;
      m_ClimberRequestedState = ClimberStates.StateStopped;
      
      TalonFXConfiguration whee = new TalonFXConfiguration();
      whee.MotorOutput.NeutralMode = NeutralModeValue.Brake;
      m_talonRight.setNeutralMode(NeutralModeValue.Brake);

      m_talonLeft.setNeutralMode(NeutralModeValue.Brake);
  }
